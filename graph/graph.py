...
parallelGraph.add_node(research_debate_node)
...
# draw edges between the analysts to the research debate node 
# (contains bullish and bearish researchers intial and counter arguments)
parallelGraph.add_edge(fundamental_analyst_node, research_debate_node)
parallelGraph.add_edge(sentimental_analyst_node, research_debate_node)
parallelGraph.add_edge(news_analyst_node, research_debate_node)
parallelGraph.add_edge(technical_analyst_node, research_debate_node)

# connect edges to advisory panel (trader, risk mgmt, and manager)
parallelGraph.add_edge(research_debate_node, research_manager_node)
parallelGraph.add_edge(research_debate_node, trader_node)
